...
export default function LandingPage() {
  return (
    <div className="bg-stone-300 dark:bg-stone-950 h-screen">
        ...
        <div className="mx-auto max-w-2xl py-12">
          <div className="text-center">
            ...
            <p className="dark:text-gray-100 mt-6 text-lg leading-8 text-gray-600">
              Erudition acts as your document hacker, storing all your docs
              and allowing you to understand them easier.
            </p>
